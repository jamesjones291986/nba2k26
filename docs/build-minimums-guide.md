...
You earn badge level increases through gameplay progression:

| Boost Pool | Boosts Available | Total Levels |
|------------|-----------------|--------------|
| **Shooting** | +1 and +2 | +3 across shooting badges |
...
| Dimer | Tier 2 | Free from Break Starter investment | 82 Pass Accuracy = Gold (already covered by 87) |
